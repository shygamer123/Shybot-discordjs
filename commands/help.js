...
module.exports={
  ...
  execute(message, args){
    ...
    help.addField('Moderation:-','`mute` `unmute` `lock` `unlock` `clear`')
    ...
    help.addField('Economy:-','`balance` `beg` `buy` `daily` `inventory` `leaderboard` `rob` `search` `shop` `transfer` `weekly` `work`')
